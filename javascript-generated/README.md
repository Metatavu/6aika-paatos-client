...
*PaatosApiClient.ActionsApi* | [**actionsRetrieve**](docs/ActionsApi.md#actionsRetrieve) | **GET** /action/{id}/ | Retrieve a single action by ID
*PaatosApiClient.CasesApi* | [**casesList**](docs/CasesApi.md#casesList) | **GET** /case/ | Retrieve a list of cases
*PaatosApiClient.CasesApi* | [**casesRetrieve**](docs/CasesApi.md#casesRetrieve) | **GET** /case/{id}/ | Retrieve a single case by ID
...
*PaatosApiClient.EventsApi* | [**eventsList**](docs/EventsApi.md#eventsList) | **GET** /event/ | Retrieve a list of events
*PaatosApiClient.EventsApi* | [**eventsRetrieve**](docs/EventsApi.md#eventsRetrieve) | **GET** /event/{id}/ | Retrieve a single event by ID
*PaatosApiClient.FunctionsApi* | [**functionsList**](docs/FunctionsApi.md#functionsList) | **GET** /function/ | Retrieve a list of functions
*PaatosApiClient.FunctionsApi* | [**functionsRetrieve**](docs/FunctionsApi.md#functionsRetrieve) | **GET** /function/{id}/ | Retrieve a single function by ID
...
## Documentation for Models
 ...
 - [PaatosApiClient.Geometry](docs/Geometry.md)
 - [PaatosApiClient.GeometryGeometry](docs/GeometryGeometry.md)
 ...
 - [PaatosApiClient.InlineResponse2006](docs/InlineResponse2006.md)
 - [PaatosApiClient.InlineResponse2007](docs/InlineResponse2007.md)
 ...
 - [PaatosApiClient.ModelFunction](docs/ModelFunction.md)
