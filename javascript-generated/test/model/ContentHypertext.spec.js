...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 6aikaPaatosClient.ContentHypertext();
  });
  ...
  describe('ContentHypertext', function() {
    it('should create an instance of ContentHypertext', function() {
      // uncomment below and update the code to test ContentHypertext
      //var instane = new 6aikaPaatosClient.ContentHypertext();
      //expect(instance).to.be.a(6aikaPaatosClient.ContentHypertext);
    });
