...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 6aikaPaatosClient.Content();
  });
  ...
  describe('Content', function() {
    it('should create an instance of Content', function() {
      ...
      //var instane = new 6aikaPaatosClient.Content();
      //expect(instance).to.be.a(6aikaPaatosClient.Content);
    });
    ...
    it('should have the property hypertext (base name: "hypertext")', function() {
      // uncomment below and update the code to test the property hypertext
      //var instane = new 6aikaPaatosClient.Content();
      //expect(instance).to.be();
    });
