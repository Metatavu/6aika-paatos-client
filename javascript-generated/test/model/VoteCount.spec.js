...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 6aikaPaatosClient.VoteCount();
  });
  ...
  describe('VoteCount', function() {
    it('should create an instance of VoteCount', function() {
      // uncomment below and update the code to test VoteCount
      //var instane = new 6aikaPaatosClient.VoteCount();
      //expect(instance).to.be.a(6aikaPaatosClient.VoteCount);
    });
