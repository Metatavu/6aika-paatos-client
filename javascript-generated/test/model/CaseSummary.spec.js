...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 6aikaPaatosClient.CaseSummary();
  });
  ...
  describe('CaseSummary', function() {
    it('should create an instance of CaseSummary', function() {
      // uncomment below and update the code to test CaseSummary
      //var instane = new 6aikaPaatosClient.CaseSummary();
      //expect(instance).to.be.a(6aikaPaatosClient.CaseSummary);
    });
