...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 6aikaPaatosClient.Post();
  });
  ...
  describe('Post', function() {
    it('should create an instance of Post', function() {
      ...
      //var instane = new 6aikaPaatosClient.Post();
      //expect(instance).to.be.a(6aikaPaatosClient.Post);
    });

    it('should have the property otherLabel (base name: "other_label")', function() {
      // uncomment below and update the code to test the property otherLabel
      //var instane = new 6aikaPaatosClient.Post();
